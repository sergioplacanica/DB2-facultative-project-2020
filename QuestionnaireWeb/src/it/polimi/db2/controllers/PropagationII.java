...
public class PropagationII extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// check sullo stato bannato dell'utente in sessione, se � bannato
		// response.sendError. se non lo � verifichiamo se le sue risposte
		...
		// dopodich� inseriamo le risposte.
